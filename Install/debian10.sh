...
deb http://deb.debian.org/debian Debian10.13 main contrib non-free non-free-firmware
...
deb http://deb.debian.org/debian buster-proposed-updates main contrib non-free non-free-firmware" > ~/"$folder"/etc/apt/sources.list
